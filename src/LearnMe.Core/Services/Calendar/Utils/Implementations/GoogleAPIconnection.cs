...
namespace LearnMe.Core.Services.Calendar.Utils.Implementations
{
    ...
    {
        //public CustomCalendarService CreateCalendarService(UserCredential cred, string appName)
        //{
        //    // Create Google Calendar API service.
        //    var service = new CustomCalendarService(new BaseClientService.Initializer()
        //    {
