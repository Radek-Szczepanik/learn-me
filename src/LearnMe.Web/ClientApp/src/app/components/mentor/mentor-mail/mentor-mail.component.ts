...
import { AddMailDialog } from './mentor-mail-add.component';
import { DeleteMailDialog } from './mentor-mail-delete.component'
...
export class MentorMailComponent implements OnInit {
  ...
  addMail() {
    ...
    const dialogRef = this.dialog.open(AddMailDialog, dialogConfig);
  ...
  deleteMail(message: any) {
    ...
    const dialogRef = this.dialog.open(DeleteMailDialog, dialogConfig);
